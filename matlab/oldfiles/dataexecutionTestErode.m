function [data_Derivations] = dataexecutionTestErode(start, finish)
...
%             save(sprintf('3DAD/datafileAD%1d',name1), 'data_Derivations3D');
            save(sprintf('2dADTest/datafileAD%1d',name1), 'data_DerivationsErode');
...
%             save(sprintf('3DCONTROL/datafileCO%1d',name3), 'data_Derivations3D');
            save(sprintf('2dControlTest/datafileCO%1d',name3), 'data_DerivationsErode');
