...
load('notErodeLeft2DudenNorm.mat');
load('notErodeLeft3DudenNorm.mat');
...
for a = 1:100
    ...
    for i = 1:10
        acc2D(i) = acc2D(i) + knnWithCrossval2([],selFeat2D3k,i)/100;
        acc3D1(i) = acc3D1(i) + knnWithCrossval2([],selFeat3D1k,i)/100;
        acc3D3(i) = acc3D3(i) + knnWithCrossval2([],selFeat3D3k,i)/100;
    end
