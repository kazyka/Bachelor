...
save(sprintf('knnResults/notErodeRight2DudenNorm'), 'toD');
save(sprintf('knnResults/notErodeRight3DudenNorm'), 'treD');

load('notErodeRight2DudenNorm.mat');
load('notErodeRight3DudenNorm.mat');
...
for i = 1:size(features3d,1)
    features3d(i,1) = treD{5}(i,2);
    features3d(i,2) = treD{5}(i,3);
    features3d(i,3) = treD{5}(i,4);
end

features2d= zeros(12,3);
