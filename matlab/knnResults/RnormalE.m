...
load('Right2DudenNormErode.mat');
load('Right3DudenNormErode.mat');
...
features2d= zeros(15,3);
for i = 1:size(features2d,1)
    features2d(i,1) = toD{10}(i,2);
    features2d(i,2) = toD{10}(i,3);
    features2d(i,3) = toD{10}(i,4);
end
